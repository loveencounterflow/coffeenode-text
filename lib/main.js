...
(function() {
  ...
  this.truncate = function(text, width, ellipsis) {
    var half, stop;
    if (width == null) {
      width = 20;
    }
  ...
  this.flush = function(x, width, align, filler) {
    ...
    text_length = /[\ud800-\udbff]/.test(text) ? (this.split(text)).length : x.length;
  ...
  this.lines_of = function(me, handler) {
    ...
    **Implementation Note**: Implementation of asynchronous version postponed.
     */
    if (handler == null) {
      return me.split(this.line_splitter);
    }
  ...
  this.line_splitter_with_newlines = RegExp("(" + this.line_splitter.source + ")", "g");
