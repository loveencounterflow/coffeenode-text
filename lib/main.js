...
(function() {
  var BAP, TRM, TYPES, log, rpr, _fill_in_get_matcher, _fill_in_get_method,
    __slice = [].slice;
  ...
  _fill_in_get_method = function(matcher) {
    return function(template, data, formats) {
  ...
  this.fill_in = _fill_in_get_method(_fill_in_get_matcher());
